        ...
        <div>
          <Link href="/" className="flex items-center gap-2 mb-6 group">
            ...
            <div className="flex flex-col justify-center items-start select-none">
              ...
              <span className="font-heading font-light text-xs sm:text-sm tracking-tighter text-white leading-none uppercase mt-0.5 relative -left-[1px] sm:-left-[1.5px]">ENGINEERING</span>
            </div>
          </Link>
