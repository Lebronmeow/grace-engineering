        ...
        <div className="flex items-center gap-2 sm:gap-4">
          <Link href="/" className="flex items-center gap-2 group">
            ...
            <div className="flex flex-col justify-center items-start select-none">
              ...
              <span className="font-heading font-light text-[10px] sm:text-xs tracking-tighter text-white leading-none uppercase mt-0.5 relative -left-[0.5px] sm:-left-[1px]">ENGINEERING</span>
            </div>
          </Link>
        </div>
