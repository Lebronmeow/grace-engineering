        ...
        <div className="flex items-center gap-2 sm:gap-4">
          <Link href="/" className="flex items-center gap-2 group">
            ...
            <div className="flex flex-col justify-center items-start select-none">
              <span className="font-heading font-black text-lg sm:text-xl leading-[0.85] tracking-tighter text-white uppercase">GRACE</span>
              <span className="font-heading font-light text-lg sm:text-xl leading-[0.85] tracking-tighter text-white uppercase z-10 relative">ENGINEERING</span>
            </div>
          </Link>
        </div>
