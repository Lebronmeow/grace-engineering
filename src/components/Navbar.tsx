        ...
        <div className="flex items-center gap-2 sm:gap-4">
          <Link href="/" className="flex items-center gap-2 group">
            ...
            <div className="flex flex-col justify-center items-start select-none">
              <span className="font-heading font-black text-lg sm:text-xl tracking-tighter text-white leading-[0.85] uppercase">GRACE</span>
              <span className="font-heading font-light text-[10px] sm:text-xs tracking-tighter text-white leading-[0.85] uppercase mt-0.5">ENGINEERING</span>
            </div>
          </Link>
        </div>
